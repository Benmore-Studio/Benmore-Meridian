...
################################################################################
# Dependabot Enablement Script (FREE Features Only)
################################################################################
#
# This script enables FREE GitHub Dependabot features for all repositories
# in the Patriot-Compliance-Systems organization.
#
...
#
# What this does NOT enable (these cost money):
# ❌ GitHub Advanced Security (GHAS) - $49/user/month
...
# Configuration
ORG="Patriot-Compliance-Systems"
REPOS=("Patriot_compliance" "PCS_workforce" "PCS_prod" "pcs_backend" "Audit_logs")
